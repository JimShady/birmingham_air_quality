---
title: "Manchester AIr Quality Maps"
author: "James Smith"
output:
  html_document:
    toc: true
...
authorities <- data.frame(authority_name = c('Telford and Wrekin', 'South Staffordshire', 'Cannock Chase', 'Wolverhampton', 'Dudley', 'Sandwell', 'Tamworth', 'North Warwickshire'),
                          stringsAsFactors = F)
...
plot                      <- ggplot(auth_boundary, aes(colour = lad15nm)) +
                                geom_sf() +
                                scale_colour_manual(values = rep('black', 12), name = 'Local Authority', labels = paste(1:12, auth_boundary$lad15nm)) +
                                theme(axis.text = element_blank(),
                                      axis.ticks = element_blank(),
