...
pm25_laei2013_breaks            <-  c(4:14,20)
pm25_laei2013_colours           <- c('0-4' = "#FFFFFF",
                                     '4-5' = "#01129C",
                                     '5-6' = "#0325D3",
                                     '6-7' = "#064AF4",
                                     '7-8' = "#0C95E9",
...
no2_laei2013_colours            <- c(  '0-4' = "#FFFFFF",
                                      '4-6' = "#01129C",
                                      '6-8' = "#0325D3",
                                      '8-10' = "#064AF4",
                                      '10-12' = "#0C95E9",
...
no2_laei2013_labels                    <- c('0-4', '4-6', '6-8', '8-10', '10-12', '12-14', '14-16', '16-18', '18-20','20-22','22-24', '24-26', '26-28', '28-30', '30-32', '32-40')
...
for (i in 1:length(pm25_maps_list)) {
  ...
  wards[[pm25_maps_list[i]]]  <- gsub("]", "", wards[[pm25_maps_list[i]]], fixed=T)
  wards[[pm25_maps_list[i]]]  <- gsub(",", "-", wards[[pm25_maps_list[i]]], fixed=T)
  wards[[pm25_maps_list[i]]]  <- factor(wards[[pm25_maps_list[i]]], levels = pm25_laei2013_labels)
  
  plot                       <- ggplot(wards) +
                                    geom_sf(aes(fill = wards[[pm25_maps_list[i]]]), colour='grey') +
                                    scale_fill_manual(values = pm25_laei2013_colours,
                                                      drop=FALSE,
...
for (i in 1:length(no2_maps_list)) {
  ...
  wards[[no2_maps_list[i]]]  <- gsub("]", "", wards[[no2_maps_list[i]]], fixed=T)
  wards[[no2_maps_list[i]]]  <- gsub(",", "-", wards[[no2_maps_list[i]]], fixed=T)
  wards[[no2_maps_list[i]]]  <- factor(wards[[no2_maps_list[i]]], levels = no2_laei2013_labels)
  
  plot                      <- ggplot(wards) +
                                    geom_sf(aes(fill = wards[[no2_maps_list[i]]]), colour='grey') +
                                    scale_fill_manual(values = no2_laei2013_colours,
                                                      drop=FALSE,
