...
pm25_laei2013_breaks            <-  c(4:14, 16)
pm25_laei2013_labels            <- c('0-4' = "#FFFFFF",
                                     ...
                                     '13-14' = "#FFD600",
                                     '14-16' = '#F97C00')
pm25_factors                    <- c('0-4', '4-5', '5-6', '6-7', '7-8', '8-9', '9-10', '10-11', '11-12','12-13','13-14', '14-16')
...
for (i in 1:length(pm25_maps_list)) {
  ...
  wards[[pm25_maps_list[i]]]  <- cut(pull(wards, pm25_maps_list[i]), breaks=pm25_laei2013_breaks)
...
for (i in 1:length(no2_maps_list)) {
  ...
  wards[[no2_maps_list[i]]]  <- cut(pull(wards, no2_maps_list[i]), breaks=no2_laei2013_breaks)
